          ...
          <div class="mt-4 flex flex-col gap-4 sm:gap-6">
            <div class="relative p-1">
              ...
              <input
                ...
                maxlength="50"
                class="block w-full rounded-md border-1 border-gray-300 p-3 shadow-sm outline-none focus:ring-1 focus:ring-blue-300 dark:border-[#333639] dark:bg-transparent"
              />
            </div>
            <div class="relative p-1">
              <label
              ...
              <textarea
                ...
                maxlength="160"
                rows="3"
                class="block w-full resize-none rounded-md border-1 border-gray-300 p-3 shadow-sm outline-none focus:ring-1 focus:ring-blue-300 dark:border-gray-600 dark:bg-transparent"
              ></textarea>
            </div>
            <div class="relative p-1">
              <label
